...
function AppInner() {
  ...
  if (subUser) {
    ...
    const restrictedActions = {
      ...
      updateSale: perms.canEdit ? actions.updateSale : ()=>showPermissionToast("ليس لديك صلاحية التعديل"),
      ...
      updatePurchase: perms.canEdit ? actions.updatePurchase : ()=>showPermissionToast("ليس لديك صلاحية التعديل"),
      ...
      updateClient: perms.canEdit ? actions.updateClient : ()=>showPermissionToast("ليس لديك صلاحية التعديل"),
      ...
      updateSupplier: perms.canEdit ? actions.updateSupplier : ()=>showPermissionToast("ليس لديك صلاحية التعديل"),
