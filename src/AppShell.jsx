...
function AppShell({ page, setPage, navGroups, data, actions, loading, userEmail, userId, onLogout, roleBadge, sidebarCollapsed, setSidebarCollapsed, daysUntilExpiry, security, allowedPages }) {
  ...
  const renderPage = () => {
    switch (effectivePage) {
      ...
      case "sales": return <InvoicesPage title="فواتير المبيعات" invoices={data.salesInvoices} type="sales" clients={data.clients} suppliers={data.suppliers} categories={data.categories} onAdd={actions.addSale} onUpdate={actions.updateSale} onDelete={actions.deleteSale} onAddClient={actions.addClient} userEmail={userEmail} inventory={data.inventory} onAddInventoryItem={actions.addInventoryItem} onUpdateInventoryItem={actions.updateInventoryItem} returns={data.returns} security={security} pageId="sales" />;
      case "purchases": return <InvoicesPage title="فواتير المشتريات" invoices={data.purchaseInvoices} type="purchases" clients={data.clients} suppliers={data.suppliers} categories={data.categories} onAdd={actions.addPurchase} onUpdate={actions.updatePurchase} onDelete={actions.deletePurchase} onAddSupplier={actions.addSupplier} userEmail={userEmail} inventory={data.inventory} onAddInventoryItem={actions.addInventoryItem} onUpdateInventoryItem={actions.updateInventoryItem} returns={data.returns} security={security} pageId="purchases" />;
      case "clients": return <AccountStatement parties={data.clients} invoices={data.salesInvoices} returns={data.returns} type="client" onAddParty={actions.addClient} onUpdateParty={actions.updateClient} onDeleteParty={actions.deleteClient} security={security} pageId="clients" userEmail={userEmail} />;
      case "suppliers": return <AccountStatement parties={data.suppliers} invoices={data.purchaseInvoices} returns={data.returns} type="supplier" onAddParty={actions.addSupplier} onUpdateParty={actions.updateSupplier} onDeleteParty={actions.deleteSupplier} security={security} pageId="suppliers" userEmail={userEmail} />;
      case "returns": return <ReturnsPage returns={data.returns} salesInvoices={data.salesInvoices} purchaseInvoices={data.purchaseInvoices} inventory={data.inventory} onAdd={actions.addReturn} onDelete={actions.deleteReturn} onAddInventoryItem={actions.addInventoryItem} onUpdateInventoryItem={actions.updateInventoryItem} security={security} pageId="returns" />;
